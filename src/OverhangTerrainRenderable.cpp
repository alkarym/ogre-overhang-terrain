...
namespace Ogre
{
    ...
    //-----------------------------------------------------------------------
    //-----------------------------------------------------------------------
    String OverhangTerrainRenderable::mType = "OverhangTerrainMipMap";
    //-----------------------------------------------------------------------
    //-----------------------------------------------------------------------

    //-----------------------------------------------------------------------
    OverhangTerrainRenderable::OverhangTerrainRenderable(const String& name, OverhangTerrainSceneManager* tsm)
    ...
    //-----------------------------------------------------------------------
    OverhangTerrainRenderable::~OverhangTerrainRenderable()
    {

        deleteGeometry();
    }
	//-----------------------------------------------------------------------
	uint32 OverhangTerrainRenderable::getTypeFlags(void) const
	{
		// return world flag
		return SceneManager::WORLD_GEOMETRY_TYPE_MASK;
	}
    //-----------------------------------------------------------------------
    void OverhangTerrainRenderable::deleteGeometry()
    {
        if(mTerrain)
            delete mTerrain;
    ...
    //-----------------------------------------------------------------------
    void OverhangTerrainRenderable::initialise(int startx, int startz,  
        Real* pageHeightData)
    {
    ...
    //-----------------------------------------------------------------------
    void OverhangTerrainRenderable::_getNormalAt( float x, float z, Vector3 * result )
    {
    ...
    //-----------------------------------------------------------------------
    void OverhangTerrainRenderable::_calculateNormals()
    {
    ...
    //-----------------------------------------------------------------------
    void OverhangTerrainRenderable::_notifyCurrentCamera( Camera* cam )
    {
    ...
    //-----------------------------------------------------------------------
    void OverhangTerrainRenderable::_updateRenderQueue( RenderQueue* queue )
    {
    ...
    //-----------------------------------------------------------------------
    void OverhangTerrainRenderable::getRenderOperation( RenderOperation& op )
    {
    ...
    //-----------------------------------------------------------------------
    void OverhangTerrainRenderable::getWorldTransforms( Matrix4* xform ) const
    {
        *xform = mParentNode->_getFullTransform();
    }
    //-----------------------------------------------------------------------
    const Quaternion& OverhangTerrainRenderable::getWorldOrientation(void) const
    {
        return mParentNode->_getDerivedOrientation();
    }
    //-----------------------------------------------------------------------
    const Vector3& OverhangTerrainRenderable::getWorldPosition(void) const
    {
        return mParentNode->_getDerivedPosition();
    }
    //-----------------------------------------------------------------------
    bool OverhangTerrainRenderable::_checkSize( int n )
    {
        for ( int i = 0; i < 10; i++ )
        {
            if ( ( ( 1 << i ) + 1 ) == n )
    ...
    //-----------------------------------------------------------------------
    void OverhangTerrainRenderable::_calculateMinLevelDist2( Real C )
    {
    ...
    //-----------------------------------------------------------------------
    void OverhangTerrainRenderable::_adjustRenderLevel( int i )
    {

        mRenderLevel = i;
    }
    //-----------------------------------------------------------------------
    Real OverhangTerrainRenderable::_calculateCFactor()
    {
    ...
    //-----------------------------------------------------------------------
    float OverhangTerrainRenderable::getHeightAt( float x, float z )
    {
        Vector3 start;
        Vector3 end;
    ...
    //-----------------------------------------------------------------------
    bool OverhangTerrainRenderable::intersectSegment( const Vector3 & start, const Vector3 & end, Vector3 * result )
    {
    ...
    //-----------------------------------------------------------------------
    void OverhangTerrainRenderable::_generateVertexLighting( const Vector3 &sunlight, ColourValue ambient )
    {
    ...
    //-----------------------------------------------------------------------
    Real OverhangTerrainRenderable::getSquaredViewDepth(const Camera* cam) const
    {
    ...
    //-----------------------------------------------------------------------
    const LightList& OverhangTerrainRenderable::getLights(void) const
    {
        if (mLightListDirty)
        {
    ...
    //-----------------------------------------------------------------------
    IndexData* OverhangTerrainRenderable::getIndexData(void)
    {
    ...
    //-----------------------------------------------------------------------
    IndexData* OverhangTerrainRenderable::generateTriStripIndexes(unsigned int stitchFlags)
    {
    ...
    //-----------------------------------------------------------------------
    IndexData* OverhangTerrainRenderable::generateTriListIndexes(unsigned int stitchFlags)
    {
    ...
    //-----------------------------------------------------------------------
    HardwareVertexBufferSharedPtr OverhangTerrainRenderable::createDeltaBuffer(void)
    {
    ...
    //-----------------------------------------------------------------------
    void OverhangTerrainRenderable::_updateCustomGpuParameter(
    ...
    //-----------------------------------------------------------------------
    int OverhangTerrainRenderable::stitchEdge(Neighbor neighbor, int hiLOD, int loLOD, 
