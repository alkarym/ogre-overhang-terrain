...
namespace Ogre
{
    ...
    class OverhangTerrainPageSource;
    class OverhangTerrainRenderable;
	class TerrainTile;
    class OverhangTerrainPage;

	class DataGrid;
	class MetaObjectDataGrid;
	class DynamicRenderable;
	class IsoSurface;
	class TetrahedronIsoSurface;
	class MetaObject;
	class MetaBall;
...
#       else
#    		define _OverhangTerrainPluginExport __declspec(dllimport)
#       endif
#   endif
