...
typedef std::vector < OverhangTerrainPage * > OverhangTerrainPageRow;
typedef std::vector < OverhangTerrainPageRow > OverhangTerrainPage2D;

/** Default implementation of RaySceneQuery. */
class _OverhangTerrainPluginExport OverhangTerrainRaySceneQuery : public OctreeRaySceneQuery
{
protected:
...
/** This is a basic SceneManager for organizing TerrainTiles into a total landscape.
...
class _OverhangTerrainPluginExport OverhangTerrainSceneManager : public OctreeSceneManager
{
public:
    OverhangTerrainSceneManager(const String& name);
    virtual ~OverhangTerrainSceneManager( );

    inline DataGrid* getDataGrid() {return mDataGrid;}
    inline IsoSurfaceBuilder* getIsoSurfaceBuilder() {return mIsoSurfaceBuilder;}
    ...
    /** Aligns TerrainTile neighbors, and renders them. */
    ...
    */
    virtual TerrainTile* getTerrainTile( const Vector3 & pt );

    /** Returns the TerrainPage that contains the given pt.
    If no page exists at the point, it returns 0;
    */
    virtual OverhangTerrainPage* getTerrainPage( const Vector3 & pt );
    ...
    */
    ...
    typedef std::map<String, OverhangTerrainPageSource*> PageSourceMap;
    ...
    */
    virtual void registerPageSource(const String& typeName, OverhangTerrainPageSource* source);
    ...
    */
    virtual void attachPage(ushort pageX, ushort pageZ, OverhangTerrainPage* page);
	...
	OverhangTerrainBufferCache& _getIndexCache(void) {return mIndexCache;}
	...
	/** Adds a MetaObject to the SceneManager.
	*/
	void addMetaObject(MetaObject *mo);
	/// Convenience function to add the most common MetaObject.
	void addMetaBall(Vector3 position, Real radius, bool excavating = true);
...
protected:
    ...
    OverhangTerrainOptions mOptions;
    ...
    OverhangTerrainPage2D mTerrainPages;
	//-- attributes to share across tiles
	/// Shared list of index buffers
	OverhangTerrainBufferCache mIndexCache;
    ...
    OverhangTerrainPageSource* mActivePageSource;

	DataGrid *mDataGrid;
	IsoSurfaceBuilder *mIsoSurfaceBuilder;
...
{
protected:
	typedef std::vector<OverhangTerrainPageSource*> OverhangTerrainPageSources;
	OverhangTerrainPageSources mTerrainPageSources;
