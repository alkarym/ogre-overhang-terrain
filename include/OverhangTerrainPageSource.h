...
namespace Ogre {
    ...
    typedef std::pair<String, String> OverhangTerrainPageSourceOption;
    typedef std::vector<OverhangTerrainPageSourceOption> OverhangTerrainPageSourceOptionList;
    ...
    */
    class _OverhangTerrainPluginExport OverhangTerrainPageSourceListener
    {
    public:
        ...
        */
        virtual void pageConstructed(OverhangTerrainSceneManager* manager, size_t pagex, size_t pagez, Real* heightData) = 0;
    };

	/** Simple manager class to hold onto a list of page source listeners 
	    across all sources.
	*/
	class _OverhangTerrainPluginExport OverhangTerrainPageSourceListenerManager :
		public Singleton<OverhangTerrainPageSourceListenerManager>
	{
	protected:
        typedef std::vector<OverhangTerrainPageSourceListener*> PageSourceListenerList;
        PageSourceListenerList mPageSourceListeners;
	public:
        OverhangTerrainPageSourceListenerManager() {}
        ~OverhangTerrainPageSourceListenerManager() {}
        ...
        */
        void addListener(OverhangTerrainPageSourceListener* pl);
        /** Unregister a class which will be called back whenever a new page is
        available.
        */
        void removeListener(OverhangTerrainPageSourceListener* pl);
		
        /// Fire pageContructed events
        void firePageConstructed(OverhangTerrainSceneManager* manager, size_t pagex, size_t pagez, Real* heightData);

       /** Override standard Singleton retrieval.
        */
        static OverhangTerrainPageSourceListenerManager& getSingleton(void);
        /** Override standard Singleton retrieval.
        */
        static OverhangTerrainPageSourceListenerManager* getSingletonPtr(void);	
    ...
    */
    class _OverhangTerrainPluginExport OverhangTerrainPageSource
    {
    protected:
        /// Link back to parent manager
        OverhangTerrainSceneManager* mSceneManager;
        ...
        @remarks
            ...
            creates.
        */
        virtual OverhangTerrainPage* buildPage(Real* heightData, const MaterialPtr& pMaterial);


    public:
        OverhangTerrainPageSource(); 
        virtual ~OverhangTerrainPageSource() { shutdown(); }
        ...
        */
        virtual void initialise(OverhangTerrainSceneManager* tsm, 
        ...
        */
        ...
        @remarks
            ...
            is in active use; there is no need to register one per source.
        */
        static void addListener(OverhangTerrainPageSourceListener* pl);
        /** Unregister a class which will be called back whenever a new page is
        available.
        */
        static void removeListener(OverhangTerrainPageSourceListener* pl);
