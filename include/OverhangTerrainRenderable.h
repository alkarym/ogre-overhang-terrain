...
*/
/***************************************************************************
OverhangTerrainrenderable.h  -  description
-------------------
...
namespace Ogre
{
    ...
    */
    class OverhangTerrainBufferCache
    {
    public:
        void shutdown(void)
        {
    ...
    both OverhangTerrainSceneManager and TerrainRenderable.
    */
...
#define STITCH_EAST   128 << STITCH_EAST_SHIFT
    ...
    */
	...
	class _OverhangTerrainPluginExport OverhangTerrainRenderable : public Renderable, public MovableObject
    {
    public:

        OverhangTerrainRenderable(const String& name, OverhangTerrainSceneManager* tsm);
        virtual ~OverhangTerrainRenderable();
	...
	/* added manually */
        ...
        */
        void _setNeighbor( Neighbor n, OverhangTerrainRenderable *t )
        {
            mNeighbors[ n ] = t;
        };
        ...
        */
        OverhangTerrainRenderable * _getNeighbor( Neighbor n )
        {
            return mNeighbors[ n ];
        }


        virtual void setMaterial(const MaterialPtr& m )
        {
            mMaterial = m;
        };
    ...
    protected:
        ...
        const OverhangTerrainOptions* mOptions;
        ...
        OverhangTerrainRenderable *mNeighbors [ 4 ];
